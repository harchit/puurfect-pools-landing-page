    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-3 sm:gap-6 lg:gap-8">
          ...
          <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-3.5 sm:px-5 text-xs sm:text-sm h-8 sm:h-10">
          ...
          <a href={telLink} className="hidden sm:flex text-sm font-bold text-white hover:text-blue-400 items-center gap-1.5">
